...
namespace GeoReader.Entities
{
    public class Header
    {
        public Header(int version, string name, DateTime timestamp, int records, uint offsetRanges, uint offsetCities,
        ...
        public uint
            OffsetRanges { get; } // смещение относительно начала файла до начала списка записей с геоинформацией
        ...
        public uint
            OffsetLocations { get; } // смещение относительно начала файла до начала списка записей о местоположении
    }
}